...
class DataDiscoveryTest(unittest.TestCase):
    def testFormatOutput(self):
        ...
        task = {'tm_taskname': requestname}
        #just using some locations for this dataset
        locations = {'/GenericTTbar/HC-CMSSW_5_3_1_START53_V5-v1/GEN-SIM-RECO#289639b0-146f-411b-a220-fcdff0a13cd9': \
                                [u'ganymede.hep.kbfi.ee', u'srm.ihepa.ufl.edu', u'storm-se-01.ba.infn.it', ]}
        #and just using some files
        datasetfiles = {}
        datasetfiles['/store/mc/HC/GenericTTbar/GEN-SIM-RECO/CMSSW_5_3_1_START53_V5-v1/0011/626F3DC8-1EAE-E111-A64C-0025902CB6B0.root'] = \
            {'NumberOfEvents': 1700L, 'BlockName': '/GenericTTbar/HC-CMSSW_5_3_1_START53_V5-v1/GEN-SIM-RECO#289639b0-146f-411b-a220-fcdff0a13cd9', \
        ...
        datasetfiles['/store/mc/HC/GenericTTbar/GEN-SIM-RECO/CMSSW_5_3_1_START53_V5-v1/0011/7A5634E8-03AE-E111-9363-5404A63886EC.root'] = \
            {'NumberOfEvents': 1700L, 'BlockName': '/GenericTTbar/HC-CMSSW_5_3_1_START53_V5-v1/GEN-SIM-RECO#289639b0-146f-411b-a220-fcdff0a13cd9',
        ...
        #Instantiate DataDiscovery and call format output
        config = Configuration()
        config.section_("MyProxy")
        config.MyProxy.serverhostcert, config.MyProxy.serverhostkey = Requests().getKeyCert()
        obj = DataDiscovery(config, 0, 0)
        res = obj.formatOutput(task=task, requestname=requestname, datasetfiles=datasetfiles, locations=locations)
